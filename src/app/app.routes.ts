...
export const routes: Routes = [
    ...
    {path: 'inscripcion/:slug' , loadComponent: () => import('./views/publico/inscripcion/inscripcion').then(m => m.InscripcionComponent)},
    ...
    {path: 'main-view', loadComponent: () => import('./views/main-view/main-view').then(m => m.MainView),
        ...
        children: [
            ...
            {path: 'editar-torneo/:slug', data: { roles: ['adminGral'] }, loadComponent: () => import('./views/admin/torneos/editar-torneo/editar-torneo').then(m => m.EditarTorneoComponent)},
            {path: 'detalle-torneo/:slug', data: { roles: ['adminGral'] }, loadComponent: () => import('./views/admin/torneos/torneo-detalles/torneo-detalles').then(m => m.TorneoDetalleComponent)},
            ...
            {path: 'detalle-liga/:slug', data: { roles: ['adminGral'] }, loadComponent: () => import('./views/admin/ligas/detalles-liga/detalles-liga').then(m => m.DetalleLigaComponent)},
            {path: 'editar-liga/:slug', data: { roles: ['adminGral'] }, loadComponent: () => import('./views/admin/ligas/editar-liga/editar-liga').then(m => m.EditarLigaComponent)},
